...
N/A — `ConnectorConfig`, `GitHubConnectorConfig`, and `AzureDevOpsConnectorConfig` are
immutable configuration data records with no methods beyond those auto-generated by C#.
